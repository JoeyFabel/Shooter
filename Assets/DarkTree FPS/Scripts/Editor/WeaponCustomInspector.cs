...
namespace DarkTreeFPS {
    ...
    public class WeaponCustomInspector : Editor
    {
        ...
        public void DrawFirearms()
        {
            ...
            GUILayout.Label("Availabe Fire Modes");
            weapon.burstEnabled = EditorGUILayout.Toggle("Burst", weapon.burstEnabled);
            weapon.automaticEnabled = EditorGUILayout.Toggle("Automatic", weapon.automaticEnabled);

            if (weapon.burstEnabled)
            {
                GUILayout.BeginVertical("GroupBox");
                GUILayout.Label("Bullets per burst");
                weapon.burstAmount = EditorGUILayout.IntField(weapon.burstAmount);
                GUILayout.EndVertical();
            }
