...
public class CoverList : MonoBehaviour
{
    ...
    public void NotifyNPCAboutShot(Vector3 playerPosition, float weaponShotNPCDetectionDistance)
    {
        ...
        {
            Debug.Log("Notify npc call: Distance is: " + Vector3.Distance(npc.transform.position, playerPosition)+", and detection distance is: "+weaponShotNPCDetectionDistance, gameObject);
